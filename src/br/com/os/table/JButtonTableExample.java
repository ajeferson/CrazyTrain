...
public class JButtonTableExample {
    ...
    public JButtonTableExample() {
        ...
        table.getColumn("Button").setCellRenderer(new ButtonRendere());
        table.getColumn("Button").setCellEditor(new ButtonEdito(new JCheckBox()));
...
class ButtonEdito extends DefaultCellEditor {

    protected JButton button;
    private String label;
    private boolean isPushed;

    public ButtonEdito(JCheckBox checkBox) {
        super(checkBox);
        button = new JButton();
